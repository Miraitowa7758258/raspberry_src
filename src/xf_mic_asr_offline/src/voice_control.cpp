...
void guess_flag_Callback(std_msgs::Int8 msg)
{
	guess_flag = msg.data;
	if (guess_flag == 1)
	{
		set_awake_word(awake_words_game);
		sleep(1.5);
	}
	else if(guess_flag == 0)
	{
...
int main(int argc, char *argv[])
{
	...
	ros::Subscriber guess_flag_sub = n.subscribe("guess_flag", 1, guess_flag_Callback);
